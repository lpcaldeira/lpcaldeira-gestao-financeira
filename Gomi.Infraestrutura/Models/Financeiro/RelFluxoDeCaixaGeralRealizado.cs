...
{
    public class RelFluxoDeCaixaGeralRealizado
    {
    
        public RelFluxoDeCaixaGeralRealizado(int seq,   DateTime competencia, string nomepessoa, string categoria, string descricao, decimal recebimentos,
